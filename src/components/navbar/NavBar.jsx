      ...
      <nav className=" container m-auto flex items-center justify-between">
        ...
        >
          ...
          >
              ...
              >
                <a
                  ...
                  className={`uppercase cursor-pointer text-black hover:text-purple-600 font-bold ${
                    item.name === activeIndex ? "text-green-600" : ""
                  }`}
                >
                  {item.name}
                </a>
            ...
            <a
              href=""
              className="bg-black text-[1rem] text-white px-8 py-2 rounded-lg font-bold hover:text-blue-700 md:m-5 md:block md:mx-auto md:w-fit lg:px-3"
            >
            <a href="https://in.linkedin.com/in/ankit-prajapathi-a-388596244?trk=public_profile_browsemap" target="_blank">HIRE ME</a>
            </a>
          </ul>
        </div>
      </nav>
