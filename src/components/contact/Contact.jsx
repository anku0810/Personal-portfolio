    ...
    <div id="contact" className="container m-auto mt-16">
      ...
      // data-aos="fade-up"
       className="relative mb-5">
        <h3 className=" text-4xl font-black text-yellow-400 sm:text-2xl">
          Contact
        </h3>
        ...
        <div className="right flex-1">
          ...
          >
            ...
            <input
              className="px-3 shadow-[0_0_16px_0px_rgba(0,0,0,0.1)] p-2 rounded-lg w-full"
              type="text"
              placeholder="e.g. Ankit Prajapathi"
              name=""
            />
            <textarea
              className="px-3 shadow-[0_0_16px_0px_rgba(0,0,0,0.1)] p-2 rounded-lg w-full"
            ...
            />
            <button
              className="bg-cyan-400 w-full text-black font-semibold  p-2 rounded-lg flex items-center justify-center space-x-1"
              type="submit"
            >
              <span>Send</span>
              <RiSendPlaneFill/>
